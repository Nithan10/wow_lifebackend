...
const googleCallback = async (req, res) => {
  try {
    ...
    const frontendURL = process.env.frontendurl11 || 'http://localhost:3001';
    ...
    res.redirect(`${process.env.frontendurl11 || 'http://localhost:3001'}/auth?error=google_auth_failed`);
  }
};
